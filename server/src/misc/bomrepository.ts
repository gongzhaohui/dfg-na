 ...
 * @see Repository
 */
export class BomRepository<Entity> extends Repository<Entity> {
  ...
  protected createRelationMaps(
    ...
    return rawResults.map(rawResult => {
      ...
      const id =
        rawResult[alias + '_' + this.metadata.primaryColumns[0].databaseName];
  ...
  protected buildParentEntityTree(
    ...
    const parentEntity = entities.find(entity => {
      ...
      return (
        entity[this.metadata.primaryColumns[0].propertyName] ===
